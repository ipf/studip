...
# base version: studip-1.3
# update version: studip-1.4
...
# For detailed informations, please take a look at the update notes
# (Should be located in the same folder)


# #1
# StEP00073 alternativer Chatclient (AJAX)
#
...
# #3
# StEP00067 Nutzerkommentare bei vorläufiger Anmeldung / Teilnehmerexport anpassen
#
INSERT INTO `config` ( `config_id` , `parent_id` , `field` , `value` , `is_default` , `type` , `range` , `section` , `position` , `mkdate` , `chdate` , `description` , `comment` , `message_template` )
VALUES (
...
INSERT INTO `config` ( `config_id` , `parent_id` , `field` , `value` , `is_default` , `type` , `range` , `section` , `position` , `mkdate` , `chdate` , `description` , `comment` , `message_template` )
VALUES (
MD5( 'EXTERNAL_HELP_LOCATIONID' ) , '', 'EXTERNAL_HELP_LOCATIONID', 'default', '1', 'string', 'global', '', '0', UNIX_TIMESTAMP( ) , UNIX_TIMESTAMP( ) , 'Eine eindeutige ID zur Identifikation der gewünschten Hilfeseiten, leer bedeutet Standardhilfe', '', ''
);
INSERT INTO `config` ( `config_id` , `parent_id` , `field` , `value` , `is_default` , `type` , `range` , `section` , `position` , `mkdate` , `chdate` , `description` , `comment` , `message_template` )
VALUES (
...
INSERT INTO `config` ( `config_id` , `parent_id` , `field` , `value` , `is_default` , `type` , `range` , `section` , `position` , `mkdate` , `chdate` , `description` , `comment` , `message_template` )
VALUES (
'781e0998a1b5c998ebbc02a4f0d907ac', '', 'USER_VISIBILITY_UNKNOWN', '1', '1', 'boolean', 'global', '', '0', '0', '0', 'Sollen Nutzer mit Sichtbarkeit "unknown" wie sichtbare behandelt werden?', '', ''
); 
